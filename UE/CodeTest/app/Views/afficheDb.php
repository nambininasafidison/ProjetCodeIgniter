...
<div class="container d-flex">
	...
	<a href="http://mon.test.mit/TestDb/form"><button class="container">Inscrire</button></a>
</div>
<hr>
<div class="container d-flex">
	<FORM  action="http://mon.test.mit/TestDb/filter" methode="POST">
	...
	<FORM action="http://mon.test.mit/TestDb/filterAll" methode="POST">
                Filter: <INPUT class="input" type="text" name="all" required/>
                <INPUT type="submit" value="Filter">
        </FORM>

	<a href="http://mon.test.mit/TestDb/index"><button>All</button></a>
...
<?php
	...
	foreach($liste as $l){
		...
		echo "<TD>".$l["gmail"]."</TD>";
		echo "<TD>".$l["tel"]."</TD>";
		echo "<TD><a href='http://mon.test.mit/TestDb/delete/".$l["id"]."'>Delete</a></TD>";
		echo "<TD><a href='http://mon.test.mit/TestDb/modify/".$l["id"]."'>Modify</a></TD>";
		echo "</TR>";
	}
?>
			</TBODY>
