...
<div class="container d-flex">
       <H1 class='container primary' >Modifier une inscription</H1>
        <a href="http://mon.test.mit/"><button class="container">Lister</button></a>
...
<hr>
	...
	<?php echo "<FORM class=\"container\" action=\"http://mon.test.mit/TestDb/update/".$liste[0]["id"]."\" method=\"POST\">"?>
